...
void main() {
  ...
  group("group16", () {
    test("#AsyncValue", () {
      ...
      final group = AsyncValueGroup.group16(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16);
      expect(group.value!.t1, 1);
      expect(group.value!.t2, "value");
      expect(group.value!.t3, 1.0);
      expect(group.value!.t4, "value");
  ...
  group("group17", () {
    test("#AsyncValue", () {
      ...
      final group = AsyncValueGroup.group17(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17);
      expect(group.value!.t1, 1);
      expect(group.value!.t2, "value");
      expect(group.value!.t3, 1.0);
      expect(group.value!.t4, "value");
  ...
  group("group18", () {
    test("#AsyncValue", () {
      ...
      final group = AsyncValueGroup.group18(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18);
      expect(group.value!.t1, 1);
      expect(group.value!.t2, "value");
      expect(group.value!.t3, 1.0);
      expect(group.value!.t4, "value");
